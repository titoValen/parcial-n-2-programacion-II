<main class="home-main">
  ...
  <div class="presentacion home-presentacion">
    ...
    <!-- <video src="./video/video_1.mp4" autoplay muted loop width="100%" height="100dvh"></video> -->
  </div>

  <section class="home-section">
    <article class="home-article">
      <figure class="home-article-figure"><img class="home-article-image" src="img/photo/zapatillas_correctas.webp" alt="Imagen de zapatillas correctas"></figure>
      <h2 class="home-article-title">¿Por qué elegir las zapatillas correctas?</h2>
      <p class="home-article-description">
    ...
    <article class="home-article">
      <figure class="home-article-figure"><img class="home-article-image" src="img/photo/elegir_zapatillas.webp" alt="Imagen de cómo elegir zapatillas"></figure>
      <h2 class="home-article-title">¿Cómo elegir tus zapatillas ideales?</h2>
      <p class="home-article-description">
    ...
    <article class="home-article">
      <figure class="home-article-figure"><img class="home-article-image" src="img/photo/tendencia.webp" alt="Imagen de tendencias en zapatillas"></figure>
      <h2 class="home-article-title">Tendencias en zapatillas urbanas</h2>
      <p class="home-article-description">
